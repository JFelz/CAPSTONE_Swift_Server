    ...
    public partial class SwiftPC : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 1,
                column: "date_time",
                value: new DateTime(2023, 12, 18, 19, 57, 28, 230, DateTimeKind.Local).AddTicks(2483));
            ...
            migrationBuilder.UpdateData(
                ...
                keyColumn: "id",
                keyValue: 1,
                columns: new[] { "rating", "subject" },
                values: new object[] { 5, "I approve!" });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 2,
                columns: new[] { "rating", "subject" },
                values: new object[] { 1, "Don't recommend! Bad Product." });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 3,
                columns: new[] { "rating", "subject" },
                values: new object[] { 4, "Great purchase! Happy Customer" });
        }
